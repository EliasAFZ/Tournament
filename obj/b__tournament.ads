...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_tournament" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#3cffa1d4#;
   pragma Export (C, u00001, "tournamentB");
   ...
   u00134 : constant Version_32 := 16#457fb2da#;
   ...
   u00156 : constant Version_32 := 16#5bc1f8e3#;
   pragma Export (C, u00156, "ada__text_io__unbounded_ioS");
   u00157 : constant Version_32 := 16#27d2953a#;
   pragma Export (C, u00157, "ada__strings__unbounded__text_ioB");
   u00158 : constant Version_32 := 16#2e5d93ef#;
   pragma Export (C, u00158, "ada__strings__unbounded__text_ioS");
   u00159 : constant Version_32 := 16#c4350ff7#;
   pragma Export (C, u00159, "queuesB");
   u00160 : constant Version_32 := 16#62f43308#;
   pragma Export (C, u00160, "queuesS");
   u00161 : constant Version_32 := 16#5f29046e#;
   pragma Export (C, u00161, "stacksB");
   u00162 : constant Version_32 := 16#3586cb46#;
   pragma Export (C, u00162, "stacksS");
